...
const (
	LoyaltyEarn        LoyaltyTransactionType = "earn"
	LoyaltyRedeem      LoyaltyTransactionType = "redeem"
	LoyaltyExpire      LoyaltyTransactionType = "expire"
	LoyaltyAdminAdjust LoyaltyTransactionType = "admin_adjust"
)
...
const (
	MovePurchaseIn        MovementType = "purchase_in"
	MoveSaleOut           MovementType = "sale_out"
	MoveReturnIn          MovementType = "return_in"
	MoveAdjustment        MovementType = "adjustment"
	MoveTransferIn        MovementType = "transfer_in"
	MoveTransferOut       MovementType = "transfer_out"
	MoveReservation       MovementType = "reservation"
	MoveReservationRel    MovementType = "reservation_release"
)

type LoyaltyAccount struct {
	ID             uint        `gorm:"primaryKey" json:"id"`
	UserID         uint        `gorm:"not null;uniqueIndex" json:"user_id"`
	Tier           LoyaltyTier `gorm:"type:varchar(20);not null" json:"tier"` // bronze, silver, gold, platinum
...
type LoyaltyTransaction struct {
	...
	Type             LoyaltyTransactionType `gorm:"type:varchar(50);not null" json:"type"` // earn, redeem, expire, admin_adjust
...
type StoreLocation struct {
	...
	Type              LocationType   `gorm:"type:varchar(20);not null" json:"type"` // store, warehouse
...
type InventoryLog struct {
	...
	MovementType        MovementType `gorm:"type:varchar(50);not null" json:"movement_type"` // purchase_in, sale_out, etc.
	...
	ActorType           ActorType    `gorm:"type:varchar(20)" json:"actor_type"` // user, admin, system
